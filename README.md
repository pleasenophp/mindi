...
**NOTE** that MinDI is not maintained anymore. For Unity3D you can use instead the best maintained framework as of 2021, [Extenject (Zenject)](https://github.com/svermeulen/Extenject) that has the same philosophy as MinDI, is not opinionated, and implements much more features.
