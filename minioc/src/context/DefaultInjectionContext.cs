...
internal class DefaultInjectionContext : InjectionContext {
    ...
    public object createInstance(Type type, Instantiator instantiator, List<Dependency> dependencies) {
    ...
    public void injectDependencies(object instance, List<Dependency> dependencies) {
        if (instance == null) {
